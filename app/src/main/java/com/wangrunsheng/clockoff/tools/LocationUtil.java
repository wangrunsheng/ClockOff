 ...
 * @author LuoSiye Edit by Russell on 2017/09/14
 */
...
public class LocationUtil{
    ...
    public static void formListenerGetLocation(){
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                //位置信息变化时触发
                Logger.i(TAG, "纬度："+location.getLatitude());
                Logger.i(TAG, "经度："+location.getLongitude());
                Logger.i(TAG, "海拔："+location.getAltitude());
                Logger.i(TAG, "时间："+location.getTime());
            }
    ...
    public static void getGpsStatelliteInfo(GpsSatellite gpssatellite){
        ...
        //卫星的方位角，浮点型数据
        Logger.i(TAG, "卫星的方位角："+gpssatellite.getAzimuth());
        //卫星的高度，浮点型数据
        Logger.i(TAG, "卫星的高度："+gpssatellite.getElevation());
        //卫星的伪随机噪声码，整形数据
        Logger.i(TAG, "卫星的伪随机噪声码："+gpssatellite.getPrn());
        //卫星的信噪比，浮点型数据
        Logger.i(TAG, "卫星的信噪比："+gpssatellite.getSnr());
        //卫星是否有年历表，布尔型数据
        Logger.i(TAG, "卫星是否有年历表："+gpssatellite.hasAlmanac());
        //卫星是否有星历表，布尔型数据
        Logger.i(TAG, "卫星是否有星历表："+gpssatellite.hasEphemeris());
        //卫星是否被用于近期的GPS修正计算
        Logger.i(TAG, "卫星是否被用于近期的GPS修正计算："+gpssatellite.hasAlmanac());
    }
